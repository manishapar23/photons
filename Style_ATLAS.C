// Mainframe macro generated from application: /cvmfs/cms.cern.ch/slc7_amd64_gcc820/lcg/root/6.18.04-bcolbf5/bin/root.exe
// By ROOT version 6.18/04 on 2021-05-26 09:58:39
...
void Style_ATLAS()
{
   ...
   delete gROOT->GetStyle("ATLAS");

   TStyle *tmpStyle = new TStyle("ATLAS", "ATLAS Style");
   ...
   tmpStyle->SetTitleOffset(1.4, "x");
   tmpStyle->SetTitleOffset(1.4, "y");
